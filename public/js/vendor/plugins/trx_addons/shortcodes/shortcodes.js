...
function stevenwatkins_accordion_sc_init(e, container) {
	"use strict";
	// Accordion
	  ...
	  container.find(".sc_accordion:not(.inited)").each(function () {
	    ...
	    jQuery(this).addClass('inited').accordion({
	        ...
	        create: function (event, ui) {
	          ...
	          if (window.stevenwatkins_init_hidden_elements) stevenwatkins_init_hidden_elements(ui.panel);
	        ...
	        activate: function (event, ui) {
	          ...
	          if (window.stevenwatkins_init_hidden_elements) stevenwatkins_init_hidden_elements(ui.newPanel);
